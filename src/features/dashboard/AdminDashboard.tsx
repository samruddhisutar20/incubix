              ...
              {[
                ...
                <div key={idx} className="flex items-center justify-between py-3 first:pt-0 last:pb-0">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300">
                      Score: {app.score}/10
                    </span>
          ...
          <Card title="Cohort Milestones Alert" subtitle="Approaching deadlines">
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex flex-col gap-1 text-left p-2.5 rounded-lg bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-900/60">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold text-primary-500">{item.startup}</span>
                    <span className="text-[10px] text-red-500 font-semibold">{item.days}</span>
                  </div>
